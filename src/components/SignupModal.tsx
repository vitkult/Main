...
import { X, Mail, Lock, User, CheckCircle, AlertCircle, HelpCircle, LogIn } from 'lucide-react'
      ...
      <DialogContent className="sm:max-w-md bg-background/95 backdrop-blur-lg border border-primary/20 shadow-2xl">
        <DialogHeader className="space-y-3">
          ...
          <p className="text-muted-foreground text-sm">
            Create your account to access exclusive VITKULT features
          </p>
        </DialogHeader>
          ...
          <div className="space-y-2">
            ...
            <div className="relative">
              ...
              <Input
                ...
                className="pl-10 pr-4 h-11 border-2 border-primary/20 focus:border-primary transition-all duration-300"
                required
              />
            </div>
          </div>
        ...
        <Button
          ...
          disabled={isLoading}
          className="w-full h-11 border-2 border-muted-foreground/20 hover:border-primary/50 transition-all duration-300 mb-4"
        >
        ...
        <div className="text-center text-xs text-muted-foreground space-y-2">
          ...
          <div className="flex items-center justify-center space-x-4">
            <button
              ...
              className="text-primary hover:text-primary-glow transition-colors duration-200 flex items-center space-x-1"
            >
